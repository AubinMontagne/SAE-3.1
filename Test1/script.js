...
let totalPoints = 0;
let timer;
let tabCompletion = [false,false,false]
...
function resetVariables()
{
    ...
    seconds = 0;
    totalPoints = 0;
    tabCompletion = [false,false,false];
...
function index()
{
    ...
    let contenuPage =`<!DOCTYPE html>
                        ...
                        <body>
                            ...
                            <h2>Temps pour finir : 53 Secondes<!-- Avoir la durér avec JS --></h2>
...
{    
    ...
    let contenuPage =`<!DOCTYPE html>
                    ...
                    <body>
                        ...
                        <h2> Nombre de questions : `+ nbQuestion +` dont 1 `+ imgTF +` , 1 ` + imgF +` , 1 `+ imgM +` et 0 `+ imgD + `</h2>
...
document.getElementById("rep4").onclick = function() { clicRep(3, "QCM") };
    ...
    document.getElementById("btnPreced").onclick = function() {if(!estChronometrer){questionPrecedante(), question0()}};
