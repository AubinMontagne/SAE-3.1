...
function question1()
{
    ...
    let contenuPage =`<!DOCTYPE html>
                   ...
                   <div class="pageQuestion">
                        ...
                        <h2> Type : QCM</h2>                        <h3> "Comment utiliser le PHP ?" </h3>
                        <div id="zoneRep">
                             <div class="reponseBox" id="rep1" ><img id="img1" class="imgBtn" src="./data/imgBtn/CheckVide.png">'XAMPP'</div>
<div class="reponseBox" id="rep2" ><img id="img2" class="imgBtn" src="./data/imgBtn/CheckVide.png">'Docker'</div>
<div class="reponseBox" id="rep3" ><img id="img3" class="imgBtn" src="./data/imgBtn/CheckVide.png">'rien'</div>
<div class="reponseBox" id="rep4" ><img id="img4" class="imgBtn" src="./data/imgBtn/CheckVide.png">'Test'</div>
...
function question2()
{
    ...
    let contenuPage =`<!DOCTYPE html>
                   ...
                   <div class="pageQuestion">
                        ...
                        <h2> Type : QCM</h2>                        <h3> "Quels outils ?" </h3>
                        <div id="zoneRep">
                             <div class="reponseBox" id="rep1" ><img id="img1" class="imgBtn" src="./data/imgBtn/CheckVide.png">'Intellij'</div>
<div class="reponseBox" id="rep2" ><img id="img2" class="imgBtn" src="./data/imgBtn/CheckVide.png">'rien'</div>
<div class="reponseBox" id="rep3" ><img id="img3" class="imgBtn" src="./data/imgBtn/CheckVide.png">'VS code'</div>
<div class="reponseBox" id="rep4" ><img id="img4" class="imgBtn" src="./data/imgBtn/CheckVide.png">'Eclypse'</div>
...
function question3()
{
    ...
    let contenuPage =`<!DOCTYPE html>
                   ...
                   <div class="pageQuestion">
                        ...
                        <h2> Type : Question à choix unique</h2>                        <h3> "Comment definir une var ?" </h3>
                        <div id="zoneRep">
                             <div class="reponseBox" id="rep1" ><img id="img1" class="imgBtn" src="./data/imgBtn/RadVide.png">'Machin'</div>
<div class="reponseBox" id="rep2" ><img id="img2" class="imgBtn" src="./data/imgBtn/RadVide.png">'Chouette'</div>
...
{
    //Variables
    let reponses = [[[0,5],[0,5]],[[3,2],[3,2]],[[4,7],[4,7]],[[6,1],[6,1]],]
...
<div class="reponseBoxAssos" id="rep4">feur</div>
<div class="reponseBoxAssos" id="rep6">La 4</div>
<div class="reponseBoxAssos" id="rep8">La 6</div>
                            </div>
                        </div>
...
}function question5()
{
    ...
    let contenuPage =`<!DOCTYPE html>
                   ...
                   <div class="pageQuestion">
                        ...
                        <div id="zoneRep">
                        <div class="reponseBox" id="rep1" ><img id="img1" class="imgBtn" src="./data/imgBtn/RadVide.png">'Yop !'</div>
<div class="reponseBox" id="rep2" ><img id="img2" class="imgBtn" src="./data/imgBtn/RadVide.png">'Salut !'</div>
<div class="reponseBox" id="rep3" ><img id="img3" class="imgBtn" src="./data/imgBtn/RadVide.png">'Hey !'</div>
<div class="reponseBox" id="rep4" ><img id="img4" class="imgBtn" src="./data/imgBtn/RadVide.png">'Nope !'</div>
                        </div>
...
{
    //Variables
    let reponses = [[[1,0],[1,0]],[[2,7],[2,7]],[[5,4],[5,4]],[[6,3],[6,3]],]
...
function question7()
{
    ...
    let contenuPage =`<!DOCTYPE html>
                   ...
                   <div class="pageQuestion">
                        ...
                        <h2> Type : Question à choix unique</h2>                        <h3> "Le vrai ou faux qui est le goat ? " </h3>
                        <div id="zoneRep">
                             <div class="reponseBox" id="rep1" ><img id="img1" class="imgBtn" src="./data/imgBtn/RadVide.png">'Entoi-nne'</div>
<div class="reponseBox" id="rep2" ><img id="img2" class="imgBtn" src="./data/imgBtn/RadVide.png">'Obein'</div>
<div class="reponseBox" id="rep3" ><img id="img3" class="imgBtn" src="./data/imgBtn/RadVide.png">'Tybolt'</div>
<div class="reponseBox" id="rep4" ><img id="img4" class="imgBtn" src="./data/imgBtn/RadVide.png">'Tymauter'</div>
<div class="reponseBox" id="rep5" ><img id="img5" class="imgBtn" src="./data/imgBtn/RadVide.png">'Jeullian'</div>
