...
function index()
{
    ...
    let contenuPage =`<!DOCTYPE html>
                        ...
                        <body>
                            ...
                            <h2>feur<!-- Avoir la matiere avec JS --></h2>
...
function question1()
{
    ...
    let texteExplications = '<style>       <!--       -->     </style><p class=default>       <span style="color: #000000; font-family: Monospaced">         YOUIIT65R7U6       </span>     </p>';
...
<img class="imgQuestion" src="./data/Question 3/Compléments/null">
      ...
      <span style="color: #000000; font-family: Monospaced">
        YOUIIT65R7U6
                        ...
                        <div id="zoneRep">
                        <div class="reponseBox" id="rep1" ><img id="img1" class="imgBtn" src="./data/imgBtn/RadVide.png">'Z3TYREU'</div>
                        </div>
...
function question2()
{
    ...
    let contenuPage =`<!DOCTYPE html>
                   ...
                   <div class="pageQuestion">
                        ...
                        <h2> Type : Question à choix unique</h2><img class="imgQuestion" src="./data/Question 1/Compléments/null">
                        <h3> <style>
      <!--
      -->
    </style><p class=default>
