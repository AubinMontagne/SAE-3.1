...
const dureeTotal = 2654; //Secondes
const noteMax = 22627;
...
function index()
{
    ...
    let contenuPage =`<!DOCTYPE html>
                        ...
                        <body>
                            ...
                            <h2>swggx<!-- Avoir la matiere avec JS --></h2>
                            <h2>Temps pour finir : 2654 Secondes<!-- Avoir la durér avec JS --></h2>
...
{    
    ...
    let contenuPage =`<!DOCTYPE html>
                    ...
                    <body>
                        ...
                        <h2> Nombre de questions : `+ nbQuestion +` dont 1 `+ imgTF +` , 1 ` + imgF +` , 0 `+ imgM +` et 0 `+ imgD + `</h2>
...
function question1()
{
    ...
    let contenuPage =`<!DOCTYPE html>
                   ...
                   <div class="pageQuestion">
                        ...
                        <h2> Type : QCM</h2><img src="./data/fic00000.png" alt="fic00000.png">
                        <h3> <style>
      <!--
      -->
                        ...
                        <a href="./data/Question 0/Compléments/fic00001.pdf" download="fic00001.pdf" target="_blank"> Télécharger le fichier complémentaire numéro 1</a>
<a href="./data/Question 0/Compléments/fic00002.pdf" download="fic00002.pdf" target="_blank"> Télécharger le fichier complémentaire numéro 2</a>
<a href="./data/Question 0/Compléments/fic00003.pdf" download="fic00003.pdf" target="_blank"> Télécharger le fichier complémentaire numéro 3</a>
<a href="./data/Question 0/Compléments/fic00004.pdf" download="fic00004.pdf" target="_blank"> Télécharger le fichier complémentaire numéro 4</a>
                        <div id="zoneRep">
...
function question2()
{
    ...
    const tempsDeReponse = 1983;
    let points = 22626;
    let texteExplications = "<style>       <!--       -->     </style><p class=default>            </p>";
    let notion = 'Les types de base';
    ...
    let contenuPage =`<!DOCTYPE html>
      ...
      -->
                        ...
                        <a href="./data/Question 0/Compléments/fic00001.mp3" download="fic00001.mp3" target="_blank"> Télécharger le fichier complémentaire numéro 1</a>
                        <div id="zoneRep">
                             <div class="reponseBox" id="rep1" ><img id="img1" class="imgBtn" src="./data/imgBtn/CheckVide.png">'Réponse 2'</div>
<div class="reponseBox" id="rep2" ><img id="img2" class="imgBtn" src="./data/imgBtn/CheckVide.png">'Réponse 1'</div>
