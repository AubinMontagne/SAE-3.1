...
let nbEliminationQ1 = [false,false,false,false,];
...
function resetVariables()
{
	...
	nbEliminationQ1 = [false,false,false,false,];
...
function index()
{
    ...
    let contenuPage =`<!DOCTYPE html>
                        ...
                        <body>
                            ...
                            <h2>Temps pour finir : 60 Secondes<!-- Avoir la durér avec JS --></h2>
...
function question1()
{
    ...
    let eliminations = [1,1,-1,1,];
    let nbEliminations = 0;
    let points = 58624;
    let coutElimination = 2.0 ;
    let texteExplications = '<style>       <!--       -->     </style><p class=default>       <span style="color: #000000; font-family: Monospaced">         sgrdh       </span>     </p>';
    ...
    let contenuPage =`<!DOCTYPE html>
      ...
      <span style="color: #000000; font-family: Monospaced">
        sgrdh
                        ...
                        <div id="zoneRep">
                        <div class="reponseBox" id="rep1" ><img id="img1" class="imgBtn" src="./data/imgBtn/RadVide.png">'gdhffgsdfh'</div>
<div class="reponseBox" id="rep2" ><img id="img2" class="imgBtn" src="./data/imgBtn/RadVide.png">'sgrhjfqegsrh'</div>
<div class="reponseBox" id="rep3" ><img id="img3" class="imgBtn" src="./data/imgBtn/RadVide.png">'zretryertz'</div>
<div class="reponseBox" id="rep4" ><img id="img4" class="imgBtn" src="./data/imgBtn/RadVide.png">'qgeshrge'</div>
                        </div>
...
function question2()
{
    ...
    const tempsDeReponse = 30;
    let points = 22;
    let texteExplications = '<style>       <!--       -->     </style><p class=default>       <span style="color: #000000; font-family: Monospaced">         rdyhtf       </span>     </p>';
    ...
    let contenuPage =`<!DOCTYPE html>
                   ...
                   <div class="pageQuestion">
                        ...
                        <h2> Type : Question à choix unique</h2>                        <h3> <style>
      <!--
      -->
    </style><p class=default>
      <span style="color: #000000; font-family: Monospaced">
