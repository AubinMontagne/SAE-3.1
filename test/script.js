...
let nbEliminationQ2 = [false,false,];
...
}function question2()
{
    ...
    let eliminations = [1,1,];
    let nbEliminations = 0;
    let points = 0;
    let coutElimination = 1.0 ;
...
<img class="imgQuestion" src="./data/Question 5/Compléments/fic00000.png" alt="fic00000.png">
      ...
      -->
                        ...
                        <div id="zoneRep">
                        <div class="reponseBox" id="rep1" ><img id="img1" class="imgBtn" src="./data/imgBtn/RadVide.png">'REP1'</div>
<div class="reponseBox" id="rep2" ><img id="img2" class="imgBtn" src="./data/imgBtn/RadVide.png">'REP2'</div>
                        </div>
...
document.getElementById("rep2").onclick = function() { clicRep(1, "elimination") };
        ...
        for(let i = 0 ; i < nbEliminationQ2.length ; i++)
        {
            if(nbEliminationQ2[i] == true)
            {
                document.getElementById("rep" + (i+1)).classList.add('eliminer');
            }
        }
...
<div class="reponseBoxAssos" id="rep1">Entité 2</div>
<div class="reponseBoxAssos" id="rep3">Entité 1</div>
                            </div>
...
<div class="reponseBoxAssos" id="rep4">Association 1</div>
    ...
    function selection(element, index)
    {
        ...
        {
            for(let i = 0 ; i < lignesQ3.length ; i++)
            {
                if((lignesQ3[i][selectGauche%2][0] == selectGauche && lignesQ3[i][selectGauche%2][1] == selectDroite) || (lignesQ3[i][selectDroite%2][0] == selectGauche && lignesQ3[i][selectDroite%2][1] == selectDroite))
                {
                    lignesQ3[i][selectGauche%2] = [];
                    lignesQ3[i][selectDroite%2] = [];
                ...
                if(lignesQ3[i][0][0] == selectGauche)
                {
                    document.getElementById("rep" + (selectGauche+1)).classList.remove('selected');
                    selectGauche = -1;
                    selectDroite = -1;
                ...
                if(lignesQ3[i][1][1] == selectDroite)
                {
                    document.getElementById("rep" + (selectDroite+1)).classList.remove('selected');
                    selectGauche = -1;
                    selectDroite = -1;
            ...
            lignesQ3[Math.floor(index/2)][selectGauche%2][0] = selectGauche;
            lignesQ3[Math.floor(index/2)][selectGauche%2][1] = selectDroite;

            lignesQ3[Math.floor(index/2)][selectDroite%2][0] = selectGauche;
            lignesQ3[Math.floor(index/2)][selectDroite%2][1] = selectDroite;
