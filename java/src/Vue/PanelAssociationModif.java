...
public class PanelAssociationModif extends JPanel implements ActionListener, java.awt.event.ItemListener {
    ...
    public PanelAssociationModif(Controleur ctrl ,Question q) {
